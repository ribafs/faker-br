...
$funcionarios = "CREATE TABLE funcionarios (
...
// Registros
$funcionarios .= "INSERT INTO funcionarios (nome, email, cpf) VALUES \n";
...
for ($i=0; $i < 1000; $i++) {
    ...
    if($i<1000-1){
        $funcionarios .= "('$nome', '$email', '$cpf'),\n";
    }else{
        $funcionarios .= "('$nome', '$email', '$cpf');\n";
    }
}
$fp = fopen("gerados/funcionarios.sql", "w");
fwrite($fp, $funcionarios);
fclose($fp);
